...
def main(args):
  ...
  if args.train:
    train(args.sample, args.n_jets, args.n_consts, args.kl_weight, args.h_dim, args.z_dim)
...
if __name__ == "__main__":
  ...
  parser.add_argument("--n_consts", "-c", help="Maximum number of constituents to consider per jet, sorted in pT decreasing", type=int, default=1)
  ...
  parser.add_argument("--sample", "-s", help="Sample to train/evaluate over", default="2Prong_Contaminated")
